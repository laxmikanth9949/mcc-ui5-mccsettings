sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("mcc/workbench/admin/settings/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#mccsettings-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#mccsettings-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("mcc.workbench.admin.settings.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["mcc/workbench/admin/settings/localService/mockserver"], function (mockserver) {
