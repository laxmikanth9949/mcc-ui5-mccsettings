						...
						"inbounds": {
							"mccsettings-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mcc.workbench.admin.settings",
									"url": sap.ui.require.toUrl("mcc/workbench/admin/settings")
								}
							}
						}
					}
