sap.ui.define([
	...
	return BaseController.extend("mcc.workbench.admin.settings.controller.Workbench.MailTemplates.CreateEntity", {
		...
		onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("createWorkbenchMailTemplates").attachDisplay(null, this._onDisplay, this);
			...
			this._oViewModel = new JSONModel({
				...
				busy: false,
				mode: "create",
				viewTitle: "Create MailTemplate",
				TemplateTypeDropdownsValues: [{
					"Key": "Mail",
					"Name": "Mail"
				}, {
					"Key": "Mail (Optional)",
					...
					"Key": "Mail + PowerPoint",
					"Name": "Mail + PowerPoint"
				}],
				ProfileDropdownsValues: [{
					"Key": "mcs-gem",
					"Name": "Global Escalation Management"
				}, {
					"Key": "mcc-gss",
					"Name": "Guided Solution Support"
				}, {
					"Key": "mcs-ccm",
					"Name": "Critical Customer Management"
				}, {
					"Key": "mcc-cpc",
					"Name": "Critical Period Coverage"
				}, {
					"Key": "initiative-tcm",
					"Name": "Top Critical Customer"
				}, {
					"Key": "gcs-cem",
					"Name": "Cloud Experience Management"
				}, {
					"Key": "mcc-xim",
					"Name": "Cross Issue Management"
				}, {
					"Key": "mcc-spro",
					"Name": "MCC Special Projects"
				}, {
					"Key": "mcc-tf",
					"Name": "Taskforce"
				}, {
					"Key": "mcc-ccm-checker",
					"Name": "MCC CCM Checker"
				}, {
					"Key": "mcc-cct",
					"Name": "MCC Central Control Team"
				}, {
					"Key": "mcc-workplace-bd",
					"Name": "MCC Business Down Management"
				}, {
					"Key": "mcc-workplace-crossIssue",
					"Name": "MCC Workplace Cross Issues"
				}, {
					"Key": "mcs-ger",
					"Name": "Global Escalation Request"
				}, {
					"Key": "mcc-cim",
		...
		_navBack: function () {
			...
			this.getRouter().navTo("masterWorkbenchMailTemplates");
			//	}
		},
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("MailTemplates", {
		...
		_fnUpdateSuccess: function () {
			...
			this.getView().unbindObject();
			this.getRouter().getTargets().display("objectWorkbenchMailTemplates");
		},
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("MailTemplates", oData);
