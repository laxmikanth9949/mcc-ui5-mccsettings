sap.ui.define([
	...
	return BaseObject.extend("mcc.workbench.admin.settings.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias mcc.workbench.admin.settings.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "RoleName");
			}
